...
PARTIAL_FIELDNAMES = ["id", "tm_id", "tm_string", "name", "team", "is_duplicate", "full_name", "date_of_birth", "age", "nationality", "height", "preferred_foot", "position_group", "position", "skin_hex", "skin_color_group", "skin_lightness", "is_poc"]
